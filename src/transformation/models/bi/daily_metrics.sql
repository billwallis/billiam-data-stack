...
date_dim as (
    select date_nk as metric_date
    from warehouse.calendar.calendar
    where date_nk::date between '2018-01-01'::date and current_date
),
...
daily_transactions as (
    select
        ...
        @within(
            round(100.0 * non_essential_cost / total_cost, 4),
            0,
            100
        ) as non_essential_cost_proportion,
